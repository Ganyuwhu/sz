...
def pretrain_patchTST_multiChannel():
    ...
    parser.add_argument('--model', type=str, default='patchTST_multiChannel', help='model name')
    ...
    parser.add_argument('--target', type=list, default=['NO2', 'O3'])
...
if __name__ == '__main__':
    pretrain_patchTST_multiChannel()
